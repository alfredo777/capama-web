...
function SuperMapFilter(locations, centerlat, centerlong, zoom, div){
    new Maplace({
      map_options: {
        set_center: [centerlat,centerlong],
        zoom: zoom
      },
      locations: locations,
      map_div: div,
      controls_type: 'dropdown',
      controls_title: 'Selecciones una incidencia:'
    }).Load();
}

function CircleMap(locations, centerlat, centerlong, zoom, div, radius){
    new Maplace({
        map_options: {
        set_center: [centerlat,centerlong],
        zoom: zoom,
